...
public class QuietHoursBypassAlarm extends Activity {
    private final static String TAG = "QuietHoursBypassAlarm";
    ...
    private void startService() {
        ...
        Intent serviceIntent = new Intent(this, QuietHoursAlarmService.class);
